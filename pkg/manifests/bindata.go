...
// assets/dns/daemonset.yaml (6.081kB)
...
func assetsDnsDaemonsetYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "assets/dns/daemonset.yaml", size: 6081, mode: os.FileMode(420), modTime: time.Unix(1, 0)}
	a := &asset{bytes: bytes, info: info, digest: [32]uint8{0xcd, 0xe0, 0x2a, 0x20, 0xaf, 0x6a, 0x52, 0x64, 0xb7, 0x4d, 0xd9, 0x11, 0x15, 0xbe, 0x3f, 0xfd, 0x1c, 0xdf, 0x4b, 0xd4, 0xba, 0xf3, 0xe7, 0x83, 0x3f, 0x96, 0xef, 0x33, 0x83, 0xe8, 0xb8, 0x9b}}
	return a, nil
}
