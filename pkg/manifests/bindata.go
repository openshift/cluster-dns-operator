...
// assets/dns/daemonset.yaml (6.154kB)
...
func assetsDnsDaemonsetYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "assets/dns/daemonset.yaml", size: 6154, mode: os.FileMode(420), modTime: time.Unix(1, 0)}
	a := &asset{bytes: bytes, info: info, digest: [32]uint8{0x6b, 0x51, 0x47, 0xe6, 0xd0, 0x41, 0x6e, 0x27, 0x10, 0x89, 0xb5, 0x72, 0x41, 0x7e, 0x95, 0x8f, 0xcc, 0x43, 0x67, 0x47, 0xf5, 0x7c, 0x7b, 0x46, 0x76, 0xd0, 0xae, 0x94, 0x4e, 0x81, 0xa4, 0xd8}}
	return a, nil
}
